...
import 'package:tiktokui/widgets/fullVerticalScreenVideo.dart';
...
class _HomeViewState extends State<HomeView> {
            ...
            child: PageView.builder(
              ...
              itemCount: homeViewModel.videosUrl.length,
                itemBuilder: (BuildContext context, int index){
                  return allWidgets(context,homeViewModel.videosUrl[index] ,_isForYouSelected, _isFollowed, _isFavorite, _username, _description, width);
                },
            ),
          ),
        ],
  ...
  Stack allWidgets(BuildContext context,String videoUrl ,bool _isForYouSelected, bool _isFollowed, bool _isFavorite, String _username, String _description, double width) {
    return Stack(
